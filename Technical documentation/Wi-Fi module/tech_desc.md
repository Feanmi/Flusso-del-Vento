...
Wi-Fi стек
- STA режим: Клиент Wi-Fi сети
- AP режим: Точка доступа (до 4 подключений)
- STA+AP: Одновременная работа
...
**Wi-Fi 2.4 ГГц**: TCP/UDP, HTTP, MQTT, WebSocket

## 5. Особенности применения
- Преимущества
  - Компактность и автономность: Полноценный компьютер с Wi-Fi в миниатюрном корпусе.
  - Низкая стоимость: Одно из самых доступных решений для подключения устройств к интернету.
  - Большое сообщество и документация: Огромное количество готовых примеров, библиотек и форумов.
  - Гибкость программирования: Поддержка нескольких сред разработки и языков.
- Ограничения
  - Wi-Fi: 2.4 ГГц, чувствителен к помехам
  - Один аналоговый вход: Для проектов с несколькими аналоговыми датчиками может потребоваться расширитель (мультиплексор или внешний АЦП).
  - Требовательность к питанию: В моменты пиковой передачи по Wi-Fi потребляет до 200 мА. Источник питания должен быть стабильным и обеспечивать такой ток.

## 6. Эксплуатационные характеристики
- Рабочая температура: -40°C до +85°C.
- Температура хранения: -65°C до +125°C

- Монтаж: Монтаж в отверстия, THT